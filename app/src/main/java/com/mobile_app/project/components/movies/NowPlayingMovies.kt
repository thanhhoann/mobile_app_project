...
import com.mobile_app.project.ui.screens.NowPlayingMoviesUiState
...
@Composable
fun NowPlayingMovies(movieViewModel: MovieViewModel = hiltViewModel()) {
    ...
    Column(modifier = Modifier.padding(16.dp)) {
        ...
        when (nowPlayingMoviesUiState) {
            ...
            is NowPlayingMoviesUiState.Success -> {
                val movies =
                    (nowPlayingMoviesUiState as NowPlayingMoviesUiState.Success).nowPlayingMovies.results
                LazyRow(
